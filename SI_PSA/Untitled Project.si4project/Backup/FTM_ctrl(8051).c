...
void FTM_Ctrl_Init(void)
{
    ...
    SIM_PINSEL1 |= SIM_PINSEL1_FTM2PS1(2); /* Select Pins corresponds to the PTF1 for output */
...
void FTM_Ctrl_Set_LED_PWM(uint16_t params)
{
    if(TRUE == FTM_INIT_FLAG)
        FTM_SetChannelValue(FTM2, FTM_CHANNEL_CHANNEL0, params*FTM2_CHANNEL0_PWM_MULTIPLE);
}
