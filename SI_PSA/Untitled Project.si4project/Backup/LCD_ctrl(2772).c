...
{
    /* LCD IC: RM5365B */
	/*register addr:0x17 change pulse width,not delay,0x05:880nm*/
    LCD_REG_SET reg_set[] ={{0x00,0x0D},{0x1F,0xaa},{0x19,0x05},{0x18,0x16},{0x17,0x05}};
    /*register addr:0x17 change hsy delay,0x5B:12us*/	
//    LCD_REG_SET reg_set[] ={{0x00,0x0D},{0x1F,0xaa},{0x19,0x12},{0x18,0xD6},{0x17,0x4B}}; 	
